/*
 * $Id: EISManagedConnection.java 16756 2009-04-22 12:35:57Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/connector-base/src/main/java/org/ikasan/connector/base/outbound/EISManagedConnection.java $
 * 
 * ====================================================================
    ...
    implements ManagedConnection
{
    ...
    /**
     * Completely removes this connection and destroys it so it cannot
    ...
    /**
     * Setter for the state of this connection.
     * Apart from initialisation this state should only be updated
     * from the derived ManagedConnections.
     * 
