/*
 * $Id: ConnectionState.java 16756 2009-04-22 12:35:57Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/connector-base/src/main/java/org/ikasan/connector/base/ConnectionState.java $
 * 
 * ====================================================================
...
/**
 * Connection state defining standard JCA connector states. 
 * These states simply reflect the status of the connector's connectivity with
 * the EIS. These can be subsequently interpreted by the calling client (EJB) and
 * used to determine whether this particular state should be reflective of
    ...
    implements Serializable
{
    ...
    /** Session closed is no different from simply being connected, but included for convenience */
    ...
    /**
     * Test equality of the Message Function objects based on the 
     * function property.
     * 
     * @return id
     */
