/*
 * $Id: EISManagedConnectionFactory.java 16756 2009-04-22 12:35:57Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/connector-base/src/main/java/org/ikasan/connector/base/outbound/EISManagedConnectionFactory.java $
 * 
 * ====================================================================
 ...
 * 
 * This class is central to the creation of ConnectionFactories 
 * and ManagedConnections.
 * 
    ...
    implements ManagedConnectionFactory, Serializable
{
    ...
    private static Logger logger = 
       Logger.getLogger(EISManagedConnectionFactory.class);
   ...
   /** default serial version uid */
    ...
    protected ConnectorXMLParser xmlParser =
        ResourceLoader.getInstance().newXMLParser();
    
    /** Connector XML Transformer */
    protected ConnectorXMLTransformer xmltransformer =
        ResourceLoader.getInstance().newXMLTransformer();
    
    /** Connector XSL Transformer */
    protected ConnectorXSLTransformer xsltransformer =
        ResourceLoader.getInstance().newXSLTransformer();
    
    /** Connector Environment */
    protected ConnectorEnvironment connectorEnv =
        ResourceLoader.getInstance().newEnvironment();

    /**
     * The application server calls this method
     * to create a new EIS-specific ConnectionFactory.
     * 
     ...
     */
     public abstract Object createConnectionFactory(final ConnectionManager connectionManager) 
         throws ResourceException;
     
     /**
      * The application server or stand-alone client calls this method 
      * to create a new EIS-specific ConnectionFactory.
      * 
      *  The extending class must implement this for the specific EIS.
      */
     ...
     *  The extending class must implement this for the specific EIS.
     */
    public abstract ManagedConnection createManagedConnection(final Subject subject, 
                                                              final ConnectionRequestInfo cri) 
        throws ResourceException; 
    
    /**
     * hashCode() uses specific instance properties to generate a hashcode
     * which can be used to uniquely identify this class instance.
     * 
     * The extending class must implement this for the specific EIS.
     */ 
    @Override
    ...
    /**
     * equals() is used to determine whether two instances of 
     * this class are set with the same configuration properties.
     * 
     * The extending class must implement this for the specific EIS.
     */ 
    @Override
    ...
    /**
     * This method is called by the application server when the client
     * asks for a new connection. The application server passes in a Set 
     * of all the active virtual connections, and this object must pick 
     * one that is currently handling a physical connection that can be 
     * shared to support the new client request. Typically this sharing 
     * will be allowed if the security attributes and properties of 
     * the new request match an existing physical connection.
     * 
     ...
     */ 
    public abstract ManagedConnection matchManagedConnections(final Set connections, 
     ...
     */
    protected void validateConnectionProperties()
        throws InvalidPropertyException
    {
        if(this.clientID == null)
        {
            throw new InvalidPropertyException(
                    "ClientID property cannot be null."); //$NON-NLS-1$
        }
