/*
 * $Id: ConnectorExceptionType.java 16756 2009-04-22 12:35:57Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/connector-base/src/main/java/org/ikasan/connector/ConnectorExceptionType.java $
 * 
 * ====================================================================
...
/**
 * This is an enumeration of connector exception types providing 
 * categories within the ConnectorException and ConnectorRuntimeException.
 * 
    ...
    implements ExceptionType
{
    ...
    /**
     * Creates a new instance of <code>ConnectorExceptionType</code> with 
