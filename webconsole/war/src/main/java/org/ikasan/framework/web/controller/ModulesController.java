/*
 * $Id: ModulesController.java 16798 2009-04-24 14:12:09Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/webconsole/war/src/main/java/org/ikasan/framework/web/controller/ModulesController.java $
 * 
 * ====================================================================
...
public class ModulesController
{
    ...
    public String controlInitiator(@RequestParam(MODULE_NAME_PARAMETER_NAME) String moduleName,
            ...
            @RequestParam(INITIATOR_ACTION_PARAMETER_NAME) String initiatorAction, ModelMap model) throws Exception
    {
        Initiator initiator = moduleService.getModule(moduleName).getInitiator(initiatorName);
        ...
        return viewModule(moduleName, model);
    }
