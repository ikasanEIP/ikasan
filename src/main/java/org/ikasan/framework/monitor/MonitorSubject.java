/*
 * $Id: MonitorSubject.java 16808 2009-04-27 07:28:17Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/framework/src/main/java/org/ikasan/framework/monitor/MonitorSubject.java $
 * 
 * ====================================================================
...
public interface MonitorSubject
{
     ...
     * 
     * @param monitorlistener The monitor listener to add
     */
     ...
     * 
     * @param monitorlistener The monitor listener to remove
     * @throws MonitorListenerNotFoundException Exception if we could not find the monitor listener 
     */
