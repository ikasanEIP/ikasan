/* 
 * $Id: QuartzStatefulJob.java 16808 2009-04-27 07:28:17Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/framework/src/main/java/org/ikasan/framework/initiator/scheduled/quartz/QuartzStatefulJob.java $
 *
 * ====================================================================
...
import org.ikasan.framework.initiator.ContextDrivenInitiator;
...
public class QuartzStatefulJob implements StatefulJob
{
    ...
    private ContextDrivenInitiator initiator;
     ...
     */
    public QuartzStatefulJob(ContextDrivenInitiator initiator)
    {
    ...
    public void execute(JobExecutionContext ctx)
    {
        ...
        try
        {
            InitiatorContext context = new ScheduledDrivenQuartzContext(ctx);
            this.initiator.invoke(context);
        }
