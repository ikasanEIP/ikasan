/*
 * $Id: Initiator.java 16808 2009-04-27 07:28:17Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/framework/src/main/java/org/ikasan/framework/initiator/Initiator.java $
 * 
 * ====================================================================
...
public interface Initiator
{
     ...
     * 
     * @return boolean
     * @deprecated - use getState().isRunning()
     */
     ...
     * 
     * @return boolean
     * @deprecated - use getState().isError()
     */
     ...
     * 
     * @return boolean
     * @deprecated - use getState().isRecovering()
     */
