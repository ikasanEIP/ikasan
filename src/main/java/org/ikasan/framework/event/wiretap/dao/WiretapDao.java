/* 
 * $Id: WiretapDao.java 16808 2009-04-27 07:28:17Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/framework/src/main/java/org/ikasan/framework/event/wiretap/dao/WiretapDao.java $
 *
 * ====================================================================
...
public interface WiretapDao
{
     ...
     * @param paylaodContent - The payload content
     * @param maxResults - The maximum amount of results
     * @param firstResult - The first result
     * @return A paged wiretap search result
     */
    public PagedWiretapSearchResult findPaging(final Set<String> moduleNames, final String componentName,
            final String eventId, final String payloadId, Date fromDate, Date untilDate, String paylaodContent,
