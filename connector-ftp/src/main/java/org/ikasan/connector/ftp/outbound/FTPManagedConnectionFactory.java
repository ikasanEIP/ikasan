/*
 * $Id: FTPManagedConnectionFactory.java 16785 2009-04-24 10:56:05Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/connector-ftp/src/main/java/org/ikasan/connector/ftp/outbound/FTPManagedConnectionFactory.java $
 * 
 * ====================================================================
...
public class FTPManagedConnectionFactory extends EISManagedConnectionFactory
{
    ...
    protected TransactionJournal getTransactionJournal()
    {
        ...
        {
            SessionFactory sessionFactroy = (SessionFactory) context.getBean(NO_TX_BASE_FILE_TRANSFER_HIBERNATE_SESSION_FACTORY);
