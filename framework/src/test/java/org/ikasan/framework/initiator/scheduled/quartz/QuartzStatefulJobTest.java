/*
 * $Id: IkasanJobFactoryTest.java 13485 2008-10-28 17:49:09Z mitcje $
 * $URL: $
 * 
 * ====================================================================
...
public class QuartzStatefulJobTest
{
     ...
     * Mock objects
     */
    final ContextDrivenInitiator initiator = mockery.mock(ContextDrivenInitiator.class);
    ...
    public void test_successfulExecute()
    {
        ...
        {
            {
                // create the initiator context based on the incoming jec
                // and call the initiator invocation.
                exactly(1).of(jec).getJobDetail();
                will(returnValue(jobDetail));
                exactly(1).of(initiator).invoke(with(any(InitiatorContext.class)));
            }
        });
