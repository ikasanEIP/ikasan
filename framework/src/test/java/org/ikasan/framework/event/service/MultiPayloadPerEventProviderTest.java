/*
 * $Id: MultiPayloadPerEventProviderTest.java 16808 2009-04-27 07:28:17Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/framework/src/test/java/org/ikasan/framework/event/service/MultiPayloadPerEventProviderTest.java $
 * 
 * ====================================================================
...
/**
 * This test class supports the <code>MultiPayloadPerEventProvider</code>
 * class.
 * 
 * @author Ikasan Development Team
 */
public class MultiPayloadPerEventProviderTest
{
    /**
    ...
    public void test_failed_constructorDueToNullPayloadProvider()
    {
        ...
        new MultiPayloadPerEventProvider(aPayloadProvider, moduleName, componentName);
    }

    /**
     * Test execution of the MultiPayloadPerEventProvider based on returning no
    ...
    {
        EventProvider eventProvider = new MultiPayloadPerEventProvider(this.payloadProvider, moduleName, componentName);
        // 
        // set expectations
    ...
    /**
     * Test execution of the MultiPayloadPerEventProvider based on returning
    ...
    /**
     * Test execution of the MultiPayloadPerEventProvider based on returning one
     * payload, hence, one Event.
     * 
     * @throws ResourceException
     */
    @Test
    ...
    /**
     * Centralise the multiple payloads per event test to allow tests with
     * differing numbers of payloads.
     * 
     * @param numOfPayloads
     * @throws ResourceException
     */
    ...
    {
        return new JUnit4TestAdapter(MultiPayloadPerEventProviderTest.class);
    }
}
