/* 
 * $Id: IkasanJobFactory.java 16808 2009-04-27 07:28:17Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/framework/src/main/java/org/ikasan/framework/initiator/scheduled/quartz/IkasanJobFactory.java $
 *
 * ====================================================================
...
public class IkasanJobFactory implements JobFactory
{
     ...
     */
    public IkasanJobFactory(final ContextDrivenInitiator initiator)
    {
    ...
    public Job newJob(TriggerFiredBundle bundle) throws SchedulerException
    {
        ...
        try
        {
            Class<?>[] paramTypes = { ContextDrivenInitiator.class };
