...
public interface ContextStartJobRecord {
    ...
    /**
     * Retrieves the ContextStartJob object.
     *
     * @return The ContextStartJob object.
     */
    ContextStartJob getContextStartJob();

    /**
     * Sets the {@link ContextStartJob} for the current object.
     *
     * @param contextStartJob the {@link ContextStartJob} to be set
     */
    void setContextStartJob(ContextStartJob contextStartJob);
