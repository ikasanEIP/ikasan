...
public interface BridgingJobRecord {
    ...
    /**
     * Retrieves the BridgingJob object.
     *
     * @return The BridgingJob object.
     */
    BridgingJob getBridgingJob();

    /**
     * Sets the {@link BridgingJob} for the current object.
     *
     * @param bridgingJob the {@link BridgingJob} to be set
     */
    void setBridgingJob(BridgingJob bridgingJob);
