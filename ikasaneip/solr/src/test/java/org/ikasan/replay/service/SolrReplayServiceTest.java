...
public class SolrReplayServiceTest extends SolrTestCaseJ4
{
    ...
    public void test_unsupported_get_audit_by_id()
    {
        ...
        new SolrReplayServiceImpl(dao).getReplayAuditById(1l);
    }
    ...
    public void test_unsupported_get_audit_events_by_id()
    {
        ...
        new SolrReplayServiceImpl(dao).getReplayAuditEventsByAuditId(1l);
    }
    ...
    public void test_unsupported_get_num_audit_events_by_id()
    {
        ...
        new SolrReplayServiceImpl(dao).getNumberReplayAuditEventsByAuditId(1l);
    }
    ...
    public void test_unsupported_get_event()
    {
        ...
        new SolrReplayServiceImpl(dao).getReplayAudits(null, null, null, null, null, null);
    }
    ...
    public void test_save_exception() throws Exception
    {
        mockery.checking(new Expectations()
        {
            {
                // set event factory
                oneOf(server).add(with(any(SolrInputDocument.class)));
