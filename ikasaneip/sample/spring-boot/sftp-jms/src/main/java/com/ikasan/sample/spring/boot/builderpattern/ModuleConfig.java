...
public class ModuleConfig {
    ...
    public Module getModule(){
        ...
        ModuleBuilder mb = builderFactory.getModuleBuilder("sample-boot-sftp-jms");
    ...
    public Flow getSftpConsumerFlow(ModuleBuilder moduleBuilder, ComponentBuilder componentBuilder)
    {
        ...
        FlowBuilder sftpToLogFlowBuilder = moduleBuilder.getFlowBuilder("Sftp To Jms Flow");
    ...
    public Flow getJmsToSftpFlow(ModuleBuilder moduleBuilder, ComponentBuilder componentBuilder)
    {
        ...
        FlowBuilder jmsToSftpFlowBuilder = moduleBuilder.getFlowBuilder("Jms To Sftp Flow");
