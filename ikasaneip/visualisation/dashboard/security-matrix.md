...
|  | | | | |
|**Errors**|**error-read**|**error-write**|**error-admin**|   |
...
|  | | | | |
|**Actioned Errors**|**actioned_error-read**|**actioned_error-write**|**actioned_error-admin**|   |
...
|  | | | | |
|**Exclusions**|**exclusion-read**|**exclusion-write**|**exclusion-admin**|   |
...
|  | | | | |
|**Actioned Exclusions**|**actioned_exclusion-read**|**actioned_exclusion-write**|**actioned_exclusion-admin**|   |
...
|  | | | | |
|**System Events**|**system_event-read**|**system_event-write**|**system_event-admin**|   |
|Search/View System Events|:white_check_mark:|:white_check_mark:|:white_check_mark:|Search/View System Events|
|  | | | | |
|**Topology**|**topology-read**|**topology-write**|**topology-admin**|   |
|  | | | | |
|**Mapping**|**mapping-read**|**mapping-write**|**mapping-admin**|   |
|  | | | | |
|**Monitoring**|**monitoring-read**|**monitoring-write**|**monitoring-admin**|   |
|  | | | | |
|**Replay**|**replay-read**|**replay-write**|**replay-admin**|   |
|  | | | | |
|**Housekeeping**|**housekeeping-read**|**housekeeping-write**|**housekeeping-admin**|   |
|  | | | | |
|**User Administration**|**user_administration-read**|**user_administration-write**|**user_administration-admin**|   |
...
|  | | | | |
|**Group Administration**|**group_administration-read**|**group_administration-write**|**group_administration-admin**|   |
...
|  | | | | |
|**Role Administration**|**role_administration-read**|**role_administration-write**|**role_administration-admin**|   |
...
|  | | | | |
|**Policy Administration**|**policy_administration-read**|**policy_administration-write**|**policy_administration-admin**|   |
...
|**User Directory Administration**|**user_directory-read**|**user_directory-write**|**user_directory-admin**|   |
...
|**Scheduled Job Administration**|**scheduler-read**|**scheduler-write**|**scheduler-admin**|   |
