 ...
 */
RotateRectangleSelectionFeedbackPolicy = draw2d.policy.figure.RectangleSelectionFeedbackPolicy.extend(
    /** @lends draw2d.policy.figure.RectangleSelectionFeedbackPolicy.prototype */
    {

        NAME: "RotateRectangleSelectionFeedbackPolicy",
        /**
        ...
        onSelect: function (canvas, figure, isPrimarySelection) {
            if (figure.selectionHandles.isEmpty()) {
                ...
                let rotateHandle = this.createRotateHandle(figure, 69) // 3 = RIGHT_TOP
                figure.selectionHandles.add(rotateHandle)
                rotateHandle.setCanvas(canvas)
                rotateHandle.show(canvas)
