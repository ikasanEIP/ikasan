...
{
    private Logger logger = LoggerFactory.getLogger(ModuleComponentsConfigurationUploadDownloadWindow.class);
    ...
    public void populate(Module module)
    {
        ...
        FileDownloader fd = new FileDownloader(new ConnectorResource() {
            private final String filename = String.format("moduleConfigurationExport-%s.xml", new SimpleDateFormat("yyyy-MM-dd-HH-mm").format(new Date()));
            ...
            public DownloadStream getStream() {
                try {
                    ...
                    InputStream data  = new ByteArrayInputStream(getModuleConfigurationExport(module).toByteArray());
