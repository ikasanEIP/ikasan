...
public class BigQueueManagementServiceImplTest {
    ...
    public void setUp() throws Exception {
        ...
        service = new BigQueueManagementServiceImpl();
    }
    ...
    public void peek_unknown_queue_returns_null() throws Exception {
        String randomString = randomAlphabetic(10);
        assertNull(service.peek(QUEUE_DIR, randomString));
        validateNoQueueCreated(randomString);

        assertNull(service.peek(null, randomString));
        assertNull(service.peek(QUEUE_DIR, null));
        assertNull(service.peek(null, null));
    }

    @Test
    public void peek_empty_queue_returns_null() throws Exception {
        assertNull(service.peek(QUEUE_DIR, QUEUE_NAME));
    }
    ...
    public void peek_non_empty_queue_returns_top_of_queue() throws Exception {
        ...
        BigQueueMessage message = service.peek(QUEUE_DIR, QUEUE_NAME);
        ...
        message = service.peek(QUEUE_DIR, QUEUE_NAME);
        assertNotNull(message);
        assertEquals(bigQueueMessage1, message);
    ...
    public void size_unknown_queue_returns_zero() throws Exception {
        String randomString = randomAlphabetic(10);
        assertEquals(0, service.size(QUEUE_DIR, randomString));
        validateNoQueueCreated(randomString);

        assertEquals(0, service.size(null, randomString));
        assertEquals(0, service.size(QUEUE_DIR, null));
        assertEquals(0, service.size(null, null));
    }
