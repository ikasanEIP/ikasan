...
class SchematronValidatorTest
{
    ...
    void test_valid_no_namespace()
    {
        ...
        assertEquals(ValidationResult.Result.VALID, validationResult.getResult(), "Document should be valid");
    }

    @Test
    void test_valid_with_namespace()
    {
        SchematronValidator validator = new SchematronValidator();
        SchematronValidatorConfiguration configuration = new SchematronValidatorConfiguration();
    ...
    @Test
    void test_invalid_no_namespace()
    {
        SchematronValidator validator = new SchematronValidator();
        SchematronValidatorConfiguration configuration = new SchematronValidatorConfiguration();
        configuration.setSchematronUri("classpath:xslt/basic-no-namespace.sch.xsl");
        ...
        assertEquals(ValidationResult.Result.INVALID, validationResult.getResult(), "Document should be invalid");
    }


    @Test
    void test_valid_over_http() throws Exception
    {
        SchematronValidator validator = new SchematronValidator();
        SchematronValidatorConfiguration configuration = new SchematronValidatorConfiguration();
    ...
    @Test
    void test_valid_over_http_relative() throws Exception
    {
        SchematronValidator validator = new SchematronValidator();
        SchematronValidatorConfiguration configuration = new SchematronValidatorConfiguration();
    ...
    @Test
    void test_valid_over_http_relative_codelist() throws Exception
    {
        SchematronValidator validator = new SchematronValidator();
        SchematronValidatorConfiguration configuration = new SchematronValidatorConfiguration();
    ...
    @Test
    void test_invalid_over_http_relative_codelist() throws Exception
    {
        SchematronValidator validator = new SchematronValidator();
        SchematronValidatorConfiguration configuration = new SchematronValidatorConfiguration();
        configuration.setSchematronUri(baseUrl + "xslt/dir1/relative-codelist.sch.xsl");
    ...
    @Test
    void test_invalid_over_http_with_skip() throws Exception
    {
        SchematronValidator validator = new SchematronValidator();
        SchematronValidatorConfiguration configuration = new SchematronValidatorConfiguration();
        configuration.setSchematronUri(baseUrl + "xslt/dir1/relative-codelist.sch.xsl");
    ...
    @Test
    void test_valid_over_http_with_ignore() throws Exception
    {
        ...
        ValidationResult<Document, Document> validationResult = validator.invoke(getDocument("xml/fails-codelist.xml"));
        assertEquals(ValidationResult.Result.VALID, validationResult.getResult(), "Document should be valid");
        assertTrue(validationResult.getIgnoredRules().contains(ruleToIgnore), "Should have ignored: " + ruleToIgnore);
    }

    @Test
    void test_missing_resource_over_http() throws Exception
    {
    ...
    @Test
    void test_valid_over_http_relative_codelist_stopped_webserver() throws Exception
    {
        SchematronValidator validator = new SchematronValidator();
        SchematronValidatorConfiguration configuration = new SchematronValidatorConfiguration();
        configuration.setSchematronUri(baseUrl + "xslt/dir1/relative-codelist.sch.xsl");
        ...
        assertEquals(ValidationResult.Result.VALID, validationResult2.getResult(), "Document should still be valid");
        // start it back up
//        startJetty();
    }
