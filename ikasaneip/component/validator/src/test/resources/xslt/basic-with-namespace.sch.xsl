...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <svrl:schematron-output xmlns:xs="http://www.w3.org/2001/XMLSchema"
            ...
            <svrl:ns-prefix-in-attribute-values uri="http://ikasan.org/a" prefix="i"/>
            <svrl:active-pattern>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                    ...
                    <svrl:text>
                        ...
                        <xsl:value-of select="name(.)"/>
                        <xsl:text/>) should be 'a' and in namespace 'http://ikasan.org/a'
                    </svrl:text>
                </svrl:failed-assert>
            </xsl:otherwise>
        </xsl:choose>
