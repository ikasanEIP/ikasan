...
public class ModuleConfig
{
    ...
    public Module getModule()
    {
        ...
        // get the builders
        ModuleBuilder moduleBuilder = builderFactory.getModuleBuilder("filesystem-jms-im-3-3-x");

        Flow sourceFlow = moduleBuilder.getFlowBuilder("File System To JMS Flow")
        ...
        Flow targetFlow = moduleBuilder.getFlowBuilder("JMS To File System Flow")
