...
@WebAppConfiguration
public class ConfigurationApplicationTest extends  AbstractRestMvcTest
{
    public static final String METADATA_JSON = "/data/configuration.json";
    ...
    {
        String uri = "/rest/module/configuration";
        ...
        assertEquals(content, "Module configuration successfully captured!");
    }
