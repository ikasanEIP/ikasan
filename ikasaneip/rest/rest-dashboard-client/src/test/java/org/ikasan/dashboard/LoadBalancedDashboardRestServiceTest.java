...
public class LoadBalancedDashboardRestServiceTest
{
    ...
    LoadBalancedDashboardRestServiceImpl uut;
    ...
    public void setup()
    {
        ...
        {{
            ...
            atLeast(2).of(environment).getProperty(DashboardRestService.LOAD_BALANCED_DASHBOARD_BASE_URL_PROPERTY);
        ...
        uut = new LoadBalancedDashboardRestServiceImpl(restTemplate, environment,"/rest/harvest/wiretaps");
    ...
    public void testTimeout()
    {
        ...
        RestTemplate restTemplate = new RestTemplate(new HttpComponentsClientHttpRequestFactory());
        uut = new LoadBalancedDashboardRestServiceImpl(restTemplate, new StandardEnvironment(),"/rest/harvest/wiretaps");
