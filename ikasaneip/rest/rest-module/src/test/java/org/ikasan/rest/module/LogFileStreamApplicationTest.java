...
class LogFileStreamApplicationTest {
    ...
    void logsWithWrongPath() throws Exception {
    ...
    void logsWithReadOnlyUser() throws Exception {
    ...
    @Test
    @WithMockUser(authorities = "WebServiceAdmin")
    void logsAndCanNotExceedMaxThreads() throws Exception {
