...
public class DownloadLogFileApplicationTest {
    ...
    public void listLogFilesTest() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/rest/logs/listLogFiles")
    ...
    public void downloadLogFileTest() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/rest/logs/downloadLogFile?fullFilePath="+fullPathName)
    ...
    public void downloadLogFileNotAllowedTest() throws Exception {
        ...
        Assert.assertEquals(results.getResponse().getContentAsString(), "Not able to download the file for [some-random-file.txt]");
        Assert.assertEquals(results.getResponse().getContentType(), MediaType.APPLICATION_OCTET_STREAM_VALUE);
