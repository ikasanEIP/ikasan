/*
 * $Id: WarningSAXParseException.java 16606 2009-04-09 08:07:33Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/common/src/main/java/org/ikasan/common/xml/parser/WarningSAXParseException.java $
 * 
 * ====================================================================
 ...
 * that encapsulates an XML parse warning.
 *
 * @author Jun Suetake
 *
 */
public class WarningSAXParseException
    extends SAXParseException
{
    /** Serial GUID */
    private static final long serialVersionUID = 1517608992035343701L;

    /**
     * Creates a new instance of <code>WarningSAXParseException</code>
     * with the specified message and locator.
     * 
     * @param message 
     * @param locator 
     */
    public WarningSAXParseException(String message, Locator locator)
    {
     ...
     * @param columnNumber 
     */
    public WarningSAXParseException(String message, String publicId,
                                    String systemId,
     ...
     * @param e 
     */
    public WarningSAXParseException(SAXParseException e)
    {
