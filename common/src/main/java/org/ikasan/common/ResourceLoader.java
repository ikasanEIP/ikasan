/*
 * $Id: ResourceLoader.java 16606 2009-04-09 08:07:33Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/common/src/main/java/org/ikasan/common/ResourceLoader.java $
 * 
 * ====================================================================
...
public class ResourceLoader implements ServiceLocator
{
    ...
    /** Persistance Implementation Class */
    ...
    public static ResourceLoader getInstance()
    {
        ...
        synchronized (ResourceLoader.class)
        {
            if (instance == null)
            {
                ResourceLoader.RESOURCE_NAME = "commonResource.xml"; //$NON-NLS-1$
    ...
    protected ResourceLoader(final String resourceName)
    {
        ...
        {
            String failMsg = "Failed to load [" //$NON-NLS-1$
                    + resourceName + "]. Nothing will work! "; //$NON-NLS-1$
    ...
    {
        logger.debug("Getting contextImplClass [" + this.contextImplClass //$NON-NLS-1$
                + "]"); //$NON-NLS-1$
    ...
    public byte[] getAsByteArray(final String name) throws IOException
    {
        ...
        // Defalut else nothing on the CLASSPATH, lets try the file system
    ...
    public PayloadFactory getPayloadFactory()
    {
        ...
        {
//            payloadFactory = new PayloadFactoryImpl(getPayloadClass(), getCommonXmlParser());
