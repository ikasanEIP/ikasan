/*
 * $Id: IkasanSecurityServiceImpl.java 16606 2009-04-09 08:07:33Z mitcje $
 * $URL: svn+ssh://svc-vcsp/architecture/ikasan/trunk/common/src/main/java/org/ikasan/common/security/IkasanSecurityServiceImpl.java $
 * 
 * ====================================================================
 ...
 */
public class IkasanSecurityServiceImpl
    implements IkasanSecurityService
{
    /** The logger instance. */
        ...
        throws EncryptionPolicyNotFoundException
    {
        ...
        try
        {
            ...
            logger.warn("Application Policy [" 
                    + encryptionPolicyName + "] not found in ["
                    + encryptionPoliciesResource + "]. ");
            
            throw new EncryptionPolicyNotFoundException(encryptionPolicyName 
                    + " not found in " + encryptionPoliciesResource + ".");
        }
        catch(IOException e)
        {
